                ...
                <div class="topbar-item">
                  <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
                    ...
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                      <img src="{{ asset('admin/profile_images/'.auth()->user()->image) }}" alt="" width="30">
                    </span>
                  </div>
                </div>
                <!--end::User-->
        ...
        <div class="d-flex align-items-center mt-5">
          <div class="symbol symbol-100 mr-5">
            <div class="symbol-label"
              style="background-image:url('{{asset("admin/profile_images/".auth()->user()->image)}}')"></div>
            <i class="symbol-badge bg-success"></i>
          </div>
          <div class="d-flex flex-column">
            <span class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">{{auth()->user()->name}}</span>
            <div class="text-muted mt-1">{{auth()->user()->isSuperAdmin ? 'Super Admin' : 'Admin'}}</div>
            <div class="navi mt-2">
