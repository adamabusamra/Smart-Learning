    ...
    <div id="rs-about" class="rs-about style1 pt-50 pb-30 md-pt-30 md-pb-30">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 order-first padding-0 md-pl-15 md-pr-15 md-mb-30">
                    <div class="img-part">
    ...
    <section class="profile-section orange-color pt-30 pb-100 md-pt-30 md-pb-70 loaded">
        <div class="container">
            <div class="sec-title3 text-center mb-45">
                <h2 class="title black-color">Our Team</h2>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 pt-40 col-md-6 md-pt-0">
                    <div class="services-wrap bg4">
                        <div class="services-item">
                            <div class="services-icon">
                                <img src="assets/images/services/home6/icon/4.png" alt="images">
                            </div>
                            <div class="services-desc">
